...
<body>
    ...
    <div class="container mt-3">    
        <h2>Unidad 2 | Actividad 3 | Prueba usuarios <i class="fa-brands fa-php fa-xl"></i></h2>
    ...
    <?php 
                ...
                echo "<h2>Unidad 2 | Actividad 3 | Prueba usuarios <i class='fa-brands fa-php fa-xl'></i></h2>";
