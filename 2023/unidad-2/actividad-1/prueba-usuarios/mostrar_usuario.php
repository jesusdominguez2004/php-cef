    ...
    <div class="container mt-3">    
        ...
        <form role="form" action="mostrar_busqueda.php" method="post" name="formulario">
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" readonly value="<?php echo $nombre_u; ?>" id="nombre" name="nombre">
            </div>

            <div class="mb-3 mt-3">
                <label for="apellido">Apellido usuario:</label>
                <input type="text" class="form-control" readonly value="<?php echo $apellido_u; ?>" id="apellido" name="apellido">
            </div>
