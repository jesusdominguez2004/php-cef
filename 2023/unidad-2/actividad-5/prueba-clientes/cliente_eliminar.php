...
<body>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <select readonly class="form-control" id="tipoDocumento" name="tipoDocumento">
    ...
    <?php 
                ...
                echo "<h2>Unidad 2 | Actividad 4 | Prueba clientes <i class='fa-brands fa-php fa-xl'></i></h2>";
