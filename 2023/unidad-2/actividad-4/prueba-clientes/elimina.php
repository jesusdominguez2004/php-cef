...
<body>
    ...
    <?php 
        ...
        $consulta = $proceso -> eliminar_cliente($dato_entrada);
    ?>
    ...
    <div class="container mt-3">    
        ...
        <div class="alert alert-danger">
            ...
            ¡Se ha eliminado el cliente <?php echo "$nombres $apellidos ($id_cliente, $tipoDocumento, $numDocumento, $direccion, $correo, $telefono, $fechaNacimiento)!"?> 
        </div>
